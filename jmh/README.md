# Basic microbenchmarking for the prototype
...
Benchmarks: 
com.amadeus.middleware.odyssey.reactive.messaging.CDIReactiveStreams.directCall
com.amadeus.middleware.odyssey.reactive.messaging.OnlyReactiveStreams.directCall
com.amadeus.middleware.odyssey.reactive.messaging.OnlyReactiveStreams.reflectiveCall
```

## Starting one benchmark with profiling, reduced iterations

```
> java -jar target/benchmarks.jar CDIReactiveStreams -f 1 -wi 3 -i 3 -prof stack:lines=20;excludePackages=true 
```

## Current outcome (with 0 code optimization so far!)
...
OnlyReactiveStreams.directCall      thrpt    3  18.186 ± 2.765  ops/s
...
For profiler options:
```
> java -jar target/benchmarks.jar -prof stack:help
```
